...
public class PedidoController {
    ...
    @Operation(summary = "Operação responsável por buscar um pedido por id")
    ...
    @PutMapping({"/pedidos"})
    @Operation(summary = "Operação responsável por atualizar um pedido")
    ...
    @Operation(summary = "Operação responsável por atualizar um pedido")
    public ResponseEntity<PedidoResponse> atualizarStatusPedido(@RequestBody EdicaoPedidoRequest pedido) {
        return ResponseEntity.ok(this.pedidoService.atualizarStatusPedido(pedido));
    }

    @GetMapping({"/pedidos"})
    @Operation(summary = "Operação responsável por listar pedidos por status")
